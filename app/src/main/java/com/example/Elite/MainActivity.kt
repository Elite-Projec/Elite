...
class MainActivity : AppCompatActivity() {
    ...
    private var items = arrayListOf(
        ...
        NavigationItemModel(R.drawable.ic_report, "Report"),
        NavigationItemModel(R.drawable.ic_movie, "Crimes"),
        NavigationItemModel(R.drawable.ic_option, "Options"),
        NavigationItemModel(R.drawable.ic_profile, "Profile"),
        NavigationItemModel(R.drawable.ic_settings, "Settings"),
        NavigationItemModel(R.drawable.ic_social, "Share us on facebook")
    )
            ...
            override fun onClick(view: View, position: Int) {
                when (position) {
                    ...
                    1 -> {
                        // # Music Fragment
                        val bundle = Bundle()
                        bundle.putString("fragmentName", "Report Crime")
                    ...
                    2 -> {
                        // # Movies Fragment
                        val bundle = Bundle()
                        bundle.putString("fragmentName", "Trending Crimes")
                    ...
                    3 -> {
                        // # Books Fragment
                        val bundle = Bundle()
                        bundle.putString("fragmentName", "Options")
